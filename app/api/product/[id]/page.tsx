      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
        ...
        <div className="flex flex-col justify-between space-y-6">
          ...
          <div className="space-y-3 pt-2">
            <button className="w-full py-4 bg-black text-white font-bold rounded-2xl hover:bg-gray-800 transition-colors flex items-center justify-center gap-3 text-lg shadow-xl hover:shadow-2xl active:scale-[0.99] transition-all">
              <ShoppingBag className="w-5 h-5" />
              إضافة إلى السلة
            </button>
          </div>

          {/* مميزات الإرجاع والتوصيل */}
